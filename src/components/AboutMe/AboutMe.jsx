 ...
 */
const bio = [
  `I've always been pulled toward the same question from two different directions: why do people and systems behave the way they do? On one side, that's led me into software engineering, machine learning, and AI, where the question becomes technical: how do you model reasoning, prediction, and decision-making in code? On the other, it's led me into sociology, anthropology, psychology, and philosophy, where the question stays human: how do people construct meaning, form communities, and make choices?`,
